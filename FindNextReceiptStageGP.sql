-- invoices Not sent over to GP and next approval stage

SELECT ISNULL(p.idfWCRRGroupLineUpKey,0) AS LineSeq,D.idfRCVHeaderKey as Receipt, H.edfReceiptNumber,wcl.idfDescription AS APPROVAL , wcl.idfFlagParallelApr as Parallel,
...
SELECT h.edfReceiptNumber,d.idfRCVSessionKey,d.idfRCVHeaderKey,h.idfAmountExtended
